...
const CalendarModal = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 ${isModalOpen && "h-screen overflow-hidden"} flex h-screen w-screen flex-col overflow-auto bg-[#F8F8FA] xl:absolute xl:left-[calc(50%+228px)] xl:top-[172px] xl:h-[900px] xl:w-[388px] xl:rounded-[20px]`}
    >
