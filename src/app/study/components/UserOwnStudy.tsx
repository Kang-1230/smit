        ...
        return (
          <div key={dataItem.study_id} className="relative">
            <Link
              ...
              className="z-10 flex w-9 h-9 items-center justify-center gap-1 absolute top-5 left-64 bg-[#ffffff99] rounded-[20px]"
            >
            ...
            <Link href={`/study/${dataItem.study_id}`}>
              <div className="relative w-[312px] h-[282px] bg-[#e6e6e6] rounded-3xl m-3">
